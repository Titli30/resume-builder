function addExperience() {
  ...
  div.innerHTML = `
    ...
    <input type="text" placeholder="Duration (e.g. Jan 2021 - Dec 2022)" class="duration" required />
...
function addEducation() {
  ...
  div.innerHTML = `
    ...
    <input type="text" placeholder="Duration (e.g. Jan 2019 - Dec 2020)" class="eduDuration" required />
  `;
...
document.getElementById('resumeForm').addEventListener('submit', function(e) {
  ...
  eduEntries.forEach(entry => {
    ...
    eduHTML += `<h4>${degree} <span style="float:right; color: #555;">${eduDuration}</span></h4><p>${institution}</p>`;
  });
